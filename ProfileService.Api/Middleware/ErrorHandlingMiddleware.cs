...
namespace ProfileService.Api.Middleware
{
    public class ErrorHandlingMiddleware
    {
        ...
        public async Task InvokeAsync(HttpContext context, IProfileServiceUnitOfWork unitOfWork)
        {
            try
            {
                await _next(context);
        ...
        private static async Task HandleExceptionAsync(HttpContext context, Exception exception, IProfileServiceUnitOfWork unitOfWork)
        {
