...
{
    public class AnswerOptionsRepository : GenericWriteRepository<AnswerOption>, IAnswerOptionsRepository
    {
        public AnswerOptionsRepository(AssessmentDbContext context) : base(context)
        {
        }
    }
}
