...
{
    public class MBTIResultAnswersRepository : GenericWriteRepository<MBTIResultAnswers>, IMBTIResultAnswersRepository
    {
        public MBTIResultAnswersRepository(AssessmentDbContext context) : base(context)
        {
        }
    }
}
