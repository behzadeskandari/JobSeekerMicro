...
{
    public class PersonalityTraitsRepository : GenericWriteRepository<PersonalityTrait>, IPersonalityTraitsRepository
    {
        public PersonalityTraitsRepository(AssessmentDbContext context) : base(context)
        {
        }
    }
}
