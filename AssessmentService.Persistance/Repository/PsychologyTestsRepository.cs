...
{
    public class PsychologyTestsRepository : GenericWriteRepository<PsychologyTest>, IPsychologyTestsRepository
    {
        public PsychologyTestsRepository(AssessmentDbContext context) : base(context)
        {
        }
    }
}
